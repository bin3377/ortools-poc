...
DIRECTION_CACHE_TTL_SECONDS = int(os.getenv("DIRECTION_CACHE_TTL_SECONDS", "3600"))  # Default: 1 hour
...
async def setup_direction_indexes():
    ...
    try:
        ...
        print(f"Direction collection indexes created successfully (TTL: {DIRECTION_CACHE_TTL_SECONDS}s)")
